...
<head>
    ...
    <style>
        * {
        ...
        .konten_2 .tombol form {
            margin-right: 20px;
        }

        .konten_2 .tombol form .hapus:hover {
            background-color: rgba(221, 16, 16, 0.87);
            border: 2px solid rgba(221, 16, 16, 0.87);
        }
        ...
        .fasilitas_b {
            ...
            margin-bottom: 10px;
            background-color: transparent;
            border: 2px solid rgba(216, 16, 16, 0.966);
            transition: 0.45s;
        }

        .fasilitas_b:hover {
            border: 2px solid rgba(49, 228, 13, 0.966);
            background-color: rgba(49, 228, 13, 0.966);
        }
    ...
    ?>
        <div class="konten_2">
            ...
            <div class="box_konten">
                ...
                <div class="tombol">
                    <form action="admin_hapus_kamar.php" method="post">
                        <input type="hidden" name="id" value="<?php echo $hotel['id']; ?>">
                        <button type="submit" name="hapus_1" class="hapus">Hapus</button>
                    </form>
                    <form action="admin_edit_kamar.php" method="post">
                        <input type="hidden" name="id" value="<?php echo $hotel['id']; ?>">
                        <button type="submit" name="pesan" class="edit">Edit</button>
                    </form>
                </div>
            </div>
        </div>
...
?>
    ...
    <div class="tombol_1">
        <div class="tambah">
            <form action="admin_tambah_kamar.php" method="post">
                <button type="submit" name="tambah">Tambah Data Kamar</button>
            </form>
        </div>
        <div class="pesanan">
            <form action="admin_data_reservasi.php" method="post">
                <button type="submit" name="lihat">Lihat Data Reservasi</button>
            </form>
        </div>
    </div>
...
?>
        ...
        <div class="tombol_2">
            <form action="admin_edit_fasilitas.php" method="post">
                <button type="submit" name="edit_f" class="fasilitas_b">Edit</button>
            </form>
            <form action="admin_tambah_fasilitas.php" method="post">
                <button type="submit" name="tambah_f" class="fasilitas_b">Tambah</button>
            </form>
        </div>
    </div>
